...
def temoa_create_model(name='The Temoa Energy System Model'):
  ...
  """
    ...
    M.GroupOfTechnologies = Set(
        dimen=2)  # Set of technologies to have a minium level of activity, primarily aimed at transport sector
    ...
    M.EmissionLimitMultiplier = Param(M.time_optimize, M.commodity_emissions, default=1.0)
    ...
    M.availableActivityConstraint = Constraint(M.ActivityByPeriodAndProcessVar_ptv,
                                               rule=availableActivity_Constraint)  # Sudan
