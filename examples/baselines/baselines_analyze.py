...
if not onlySimple:
    ...
    ActivityByTODFuel = tt.getActivityTOD(folder, dbs, switch=switch, sector_name=sector_name, save_data=saveData,
    ...
    ActivityByTODTech = tt.getActivityTOD(folder, dbs, switch=switch, sector_name=sector_name, save_data=saveData,
                                          create_plots=createPlots)
